  ...
  private renderErrorDialog() {
    ...
    return (
      <Dialog open>
        ...
        >
          <div className='bg-muted/30 p-(--density-dialog-padding)'>
            <DialogHeader className='gap-(--density-control-gap)'>
              <div className='flex items-start gap-(--density-section-gap)'>
                <div className='bg-destructive/10 text-destructive mt-0.5 flex size-(--density-control-height) shrink-0 items-center justify-center'>
          ...
          <div className='grid min-w-0 gap-(--density-section-gap) p-(--density-dialog-padding)'>
            <div className='bg-card text-card-foreground grid gap-1 p-(--density-section-padding)'>
          ...
          <DialogFooter className='bg-muted/20 h-(--bar-height) items-center px-(--bar-padding-x)'>
