...
import { useCreateFolderMutation } from '@/features/file-picker/hooks/use-create-folder-mutation'
      ...
      <Tooltip>
        <PopoverTrigger
          render={
            <TooltipTrigger
              render={
                <Button aria-label='New folder' size='icon-sm' type='button' variant='ghost'>
                  <FolderPlusIcon />
                </Button>
              }
            />
