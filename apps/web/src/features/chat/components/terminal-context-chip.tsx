...
export function TerminalContextChip({
  ...
  return (
    <span
      className={cn(
        'bg-muted text-foreground inline-flex max-w-full items-center gap-1.5 rounded-md px-1.5 py-0.5 align-baseline font-mono text-[0.9em] leading-tight select-none',
        className,
      )}
