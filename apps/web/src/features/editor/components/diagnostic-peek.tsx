  ...
  return (
    <div className='pointer-events-none absolute inset-0 z-30' ref={layerRef}>
      <div
        ...
        className={cn(
          'bg-popover-solid pointer-events-auto absolute max-h-[calc(100%-1rem)] w-96 max-w-[calc(100%-1rem)] overflow-y-auto rounded-lg border border-border p-3 text-sm shadow-lg',
          !placement && 'invisible',
        )}
