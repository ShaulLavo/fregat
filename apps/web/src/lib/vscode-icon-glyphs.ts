// Shared SVG paths for inline file icons and the file tree sprite.

export const VSCODE_ICON_GLYPHS = {
  IconLayers3Middle: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M15.1 11.55a.5.5 0 0 1 0 .9l-6.65 3.33-.11.04a1 1 0 0 1-.68 0l-.1-.04L.9 12.45a.5.5 0 0 1 0-.9l1.98-1 1.68.85-1.2.6L8 14.32 12.65 12l-1.21-.6 1.68-.84z"/>
  ...
  astro: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M6.08 13.92c-.63-.57-.81-1.79-.55-2.67.45.56 1.08.73 1.73.83 1 .15 1.99.1 2.92-.37l.32-.19q.13.38.08.78a2.1 2.1 0 0 1-.9 1.5q-.3.24-.61.43c-.64.44-.81.95-.57 1.69l.02.08a1.7 1.7 0 0 1-.74-.64 2 2 0 0 1-.3-.98q0-.27-.02-.52-.07-.61-.61-.62a.7.7 0 0 0-.75.6z" class="bg" opacity=".6"/>
  ...
  bash: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M8 1c5.77 0 7 1.24 7 7s-1.24 7-7 7-7-1.24-7-7 1.24-7 7-7M6 4a.5.5 0 0 0-.5.5v.56c-.82.18-1.5.82-1.5 1.69 0 .52.24.92.6 1.2q.55.39 1.3.54.61.14.88.35.23.17.22.41c0 .33-.36.75-1 .75s-1-.42-1-.75a.5.5 0 0 0-1 0c0 .87.68 1.5 1.5 1.7v.55a.5.5 0 0 0 1 0v-.56c.82-.18 1.5-.82 1.5-1.69 0-.52-.24-.92-.6-1.2a3 3 0 0 0-1.3-.54q-.61-.14-.88-.35Q4.99 7 5 6.75C5 6.42 5.36 6 6 6s1 .42 1 .75a.5.5 0 0 0 1 0c0-.87-.68-1.5-1.5-1.7V4.5A.5.5 0 0 0 6 4m2.5 7a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1z" clip-rule="evenodd"/>`,
  },
  biome: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 2 4.88 7.35a7 7 0 0 1 3.7-.13l1.04.25-.99 4.16-1.05-.25a2.7 2.7 0 0 0-3.07 1.45l-.98-.47a4 4 0 0 1 1.07-1.31 3.8 3.8 0 0 1 3.23-.71l.5-2.08a6 6 0 0 0-5.07 1.12A5.9 5.9 0 0 0 1 14h14z"/>`,
  },
  'bootstrap-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M11.72 1.5A2.5 2.5 0 0 1 14.2 4q.02 1.08.3 2.09c.22.73.56 1.24 1.08 1.45.22.08.4.27.4.5s-.18.43-.4.51q-.76.34-1.08 1.45c-.2.65-.27 1.32-.3 2a2.5 2.5 0 0 1-2.48 2.5H4.25A2.6 2.6 0 0 1 1.7 12c-.04-.85-.1-1.68-.22-2.04C1.26 9.23.92 8.7.4 8.5.18 8.42 0 8.23 0 8s.18-.42.4-.5q.77-.35 1.09-1.46c.1-.36.17-1.19.2-2.04a2.6 2.6 0 0 1 2.56-2.5z" class="bg" clip-rule="evenodd" opacity=".2"/>
  ...
  bootstrap: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8.2 8.3q1.54 0 1.55 1.14-.02 1.13-1.5 1.14H6.78V8.3zm0-2.88c.79 0 1.23.35 1.23 1 0 .68-.52 1.06-1.45 1.06h-1.2V5.42z"/>
  ...
  'bun-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 14c3.87 0 7-2.46 7-5.49 0-1.88-1.2-3.53-3.04-4.52q-1.1-.61-1.84-1.07C9.2 2.35 8.64 2 8 2s-1.36.45-2.31 1.03A29 29 0 0 1 4.04 4C2.2 4.98 1 6.63 1 8.51 1 11.54 4.13 14 8 14" class="bg" opacity=".2"/>
  ...
  eslint: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M11.16 6.1 8.12 4.35a.3.3 0 0 0-.24 0L4.84 6.1a.3.3 0 0 0-.12.2v3.5q0 .14.12.22l3.04 1.74q.12.08.24 0l3.04-1.74a.2.2 0 0 0 .13-.22V6.3a.3.3 0 0 0-.13-.2" opacity=".5"/>
  ...
  'file-symlink': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M7.15 7.15a.5.5 0 1 1 .7.7L6.71 9h3.79a.5.5 0 0 1 0 1H6.7l1.15 1.15a.5.5 0 1 1-.7.7l-2-2a.5.5 0 0 1 0-.7z"/>
  ...
  'file-table-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 4a3 3 0 0 0 3 3h3v5.5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 12.5v-9A2.5 2.5 0 0 1 4.5 1H8z" class="bg" opacity=".4"/>
  ...
  'file-text': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8.5 11a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1zm2-2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z"/>
  <path fill="currentColor" fill-rule="evenodd" d="M9.5 1a.5.5 0 0 1 .35.15l4 4a.5.5 0 0 1 .15.35v7a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 12.5v-9A2.5 2.5 0 0 1 4.5 1zm-5 1A1.5 1.5 0 0 0 3 3.5v9A1.5 1.5 0 0 0 4.5 14h7a1.5 1.5 0 0 0 1.5-1.5V6h-2a2 2 0 0 1-2-2V2z" clip-rule="evenodd"/>`,
  },
  'file-zip-duo': {
    viewBox: '0 0 16 16',
  ...
  'file-zip': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M7 9s.5 1.017.5 1.9c0 .884-.672 1.6-1.5 1.6s-1.5-.716-1.5-1.6c0-.883.5-1.9.5-1.9h1V8h1zM6 8H5V7h1zm1-1H6V6h1zM6 6H5V5h1zm1-1H6V4h1zM6 4H5V3h1z"/>
  ...
  file: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M9.5 1a.5.5 0 0 1 .35.15l4 4a.5.5 0 0 1 .15.35v7a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 12.5v-9A2.5 2.5 0 0 1 4.5 1zm-5 1A1.5 1.5 0 0 0 3 3.5v9A1.5 1.5 0 0 0 4.5 14h7a1.5 1.5 0 0 0 1.5-1.5V6h-2a2 2 0 0 1-2-2V2z" clip-rule="evenodd"/>`,
  },
  'folder-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M14 12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6h14z" class="fg"/>
  ...
  'folder-open-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M14.26 6a1.5 1.5 0 0 1 1.43 1.93l-1.39 4.65A2 2 0 0 1 12.38 14H2.46a2 2 0 0 1-1.93-2.52L1.72 7.1A1.5 1.5 0 0 1 3.17 6z" class="fg"/>
  ...
  'folder-open': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M4.59 2a2 2 0 0 1 1.02.28l1.8 1.08a1 1 0 0 0 .5.14h4.1a2 2 0 0 1 2 2V6h.25a1.5 1.5 0 0 1 1.43 1.93l-1.39 4.65A2 2 0 0 1 12.38 14H2a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zM2 3a1 1 0 0 0-1 1v5.93l.81-2.84A1.5 1.5 0 0 1 3.25 6H13v-.5a1 1 0 0 0-1-1H7.92a2 2 0 0 1-1.03-.28L5.1 3.14A1 1 0 0 0 4.59 3z" clip-rule="evenodd"/>`,
  },
  'folder-plus-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M14 7.416A5 5 0 0 0 7.417 14H2a2 2 0 0 1-2-2V6h14zM4.585 2a2 2 0 0 1 1.028.285l1.788 1.072a1 1 0 0 0 .514.143H12A2 2 0 0 1 13.935 5H0V4a2 2 0 0 1 2-2z"/>
  <path fill="currentColor" fill-rule="evenodd" d="M12 8a4 4 0 1 1 0 8 4 4 0 0 1 0-8m0 1.5a.5.5 0 0 0-.5.5v1.5H10a.5.5 0 0 0 0 1h1.5V14a.5.5 0 0 0 1 0v-1.5H14a.5.5 0 0 0 0-1h-1.5V10a.5.5 0 0 0-.5-.5" class="fg" clip-rule="evenodd"/>`,
  },
  'folder-zip-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M4.585 2a2 2 0 0 1 1.028.285l1.788 1.072a1 1 0 0 0 .514.143H12A2 2 0 0 1 13.935 5H0V4a2 2 0 0 1 2-2z" class="bg" opacity=".5"/>
  ...
  'folder-zip': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M4.585 2a2 2 0 0 1 1.028.285l1.788 1.072a1 1 0 0 0 .514.143H12a2 2 0 0 1 2 2V12a2 2 0 0 1-2 2H2a2 2 0 0 1-.403-.041A2 2 0 0 1 0 12v-1.25h1v-1H0V4a2 2 0 0 1 2-2zM9.9 8.25c-.883 0-1.9.5-1.9.5H7v1h1v1s1.017.5 1.9.5c.884 0 1.6-.672 1.6-1.5s-.716-1.5-1.6-1.5M2 9.75v1h1v-1zm2 0v1h1v-1zm2 0v1h1v-1zm-5-1v1h1v-1zm2 0v1h1v-1zm2 0v1h1v-1zM2 3a1 1 0 0 0-1 1v2h12v-.5a1 1 0 0 0-1-1H7.915a2 2 0 0 1-1.028-.285L5.099 3.143A1 1 0 0 0 4.585 3z" clip-rule="evenodd"/>`,
  },
  folder: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M4.59 2a2 2 0 0 1 1.02.28l1.8 1.08a1 1 0 0 0 .5.14H12a2 2 0 0 1 2 2V12a2 2 0 0 1-2 2H2a2 2 0 0 1-.4-.04A2 2 0 0 1 0 12V4a2 2 0 0 1 2-2zM2 3a1 1 0 0 0-1 1v2h12v-.5a1 1 0 0 0-1-1H7.92a2 2 0 0 1-1.03-.28l-1.8-1.08A1 1 0 0 0 4.6 3z" clip-rule="evenodd"/>`,
  },
  folders: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M14 15H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2.2a2 2 0 0 1 1.38.552l.34.325a2 2 0 0 0 1.38.552H14a2 2 0 0 1 2 2V13a2 2 0 0 1-2 2" class="fg"/>
  ...
  'image-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M12.5 2A2.5 2.5 0 0 1 15 4.5v4.67l-4.05-3.54-4.08 4.08-3-2L1 10.6V4.5A2.5 2.5 0 0 1 3.5 2z" opacity=".3"/>
  ...
  image: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M5.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3"/>
  ...
  javascript: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M8 0c6.59 0 8 1.41 8 8s-1.41 8-8 8-8-1.41-8-8 1.41-8 8-8M6.17 5.1v4.45q0 .34-.08.57a1 1 0 0 1-.22.37.5.5 0 0 1-.35.12 1 1 0 0 1-.33-.1.6.6 0 0 1-.23-.3 2 2 0 0 1-.08-.57H3.7q0 .66.23 1.1.24.42.65.64.42.2.94.2t.93-.23a1.7 1.7 0 0 0 .65-.7q.25-.46.24-1.1V5.1zm3.96-.09q-.44 0-.8.13t-.62.37a2 2 0 0 0-.41.56q-.14.32-.14.72t.14.7.41.53.59.4.7.32q.3.12.5.25.2.12.31.24a1 1 0 0 1 .14.27q.04.15.04.34 0 .22-.08.4a.6.6 0 0 1-.25.28 1 1 0 0 1-.45.1q-.23 0-.41-.05a1 1 0 0 1-.32-.2 1 1 0 0 1-.2-.34 2 2 0 0 1-.06-.5H8.04q0 .52.17.91t.47.64.69.39q.39.12.82.12.45 0 .81-.12a2 2 0 0 0 .63-.36q.26-.24.4-.56a2 2 0 0 0 .13-.72q0-.4-.1-.72a2 2 0 0 0-.34-.55 2 2 0 0 0-.55-.45 5 5 0 0 0-.78-.37l-.44-.19-.33-.21a1 1 0 0 1-.22-.24 1 1 0 0 1-.07-.3q0-.24.08-.42a.6.6 0 0 1 .26-.29 1 1 0 0 1 .45-.1q.29 0 .48.12a.7.7 0 0 1 .26.35q.1.23.1.52h1.16q0-.56-.24-1a2 2 0 0 0-.68-.7Q10.75 5 10.13 5" clip-rule="evenodd"/>`,
  },
  'lang-c': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clip-rule="evenodd"/>`,
  },
  'lang-css-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 15c-5.76 0-7-1.24-7-7V2a1 1 0 0 1 1-1h6c5.77 0 7 1.24 7 7s-1.24 7-7 7" class="vector" opacity=".2"/>
  ...
  'lang-html': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="m9.41 6.8-.43 2.4h-2.4l.44-2.4z"/>
  ...
  'lang-html5-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="m14.5 1-1 12L8 15l-5.5-2-1-12z" class="bg" clip-rule="evenodd" opacity=".25"/>
  ...
  'lang-html5': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="m14.5 1-1 12L8 15l-5.5-2-1-12zm-11 2 .48 5.34h6.23l-.22 2.29-1.97.53-2.04-.53-.13-1.41H4.07L4.3 12l3.73 1 3.65-1 .51-5.44H5.63l-.16-1.81h6.87L12.5 3z" class="subtract" clip-rule="evenodd"/>`,
  },
  'lang-javascript-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  ...
  'npm-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z" class="vector" opacity=".2"/>
  <path fill="currentColor" d="M10.5 13H13V3H3v10h5V5.5h2.5z"/>`,
  },
  npm: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zm11 12h-2.5V5.5H8V13H3V3h10z"/>`,
  },
  'oxc-fill': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M9.5 1a.5.5 0 0 1 .5.5V3h3.5a.5.5 0 0 1 .38.83L10.5 7.69v1.44q.41.04.95-.16a4 4 0 0 0 .72-.35l.04-.03h.01a.5.5 0 0 1 .67.1l2 2.5a.5.5 0 0 1 0 .62c-.76.96-3.14 2.69-6.89 2.69s-6.13-1.73-6.89-2.69a.5.5 0 0 1 0-.62l2-2.5a.5.5 0 0 1 .68-.1l.04.03.16.09q.22.13.56.26.54.2.95.16V7.69L2.12 3.83A.5.5 0 0 1 2.5 3H6V1.5a.5.5 0 0 1 .5-.5z"/>`,
  },
  oxc: {
    viewBox: '0 0 16 16',
  ...
  react: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 6.65c.73 0 1.31.6 1.31 1.35S8.73 9.35 8 9.35 6.69 8.75 6.69 8 7.27 6.65 8 6.65"/>
  ...
  server: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 1c1.81 0 3.22.13 4.28.54a3.7 3.7 0 0 1 2.22 2.29q.32.9.42 2.13Q15 6.87 15 8q.02 2.02-.27 3.38-.28 1.38-1.12 2.23c-.84.85-1.3.91-2.23 1.12q-1.36.29-3.38.27a13 13 0 0 1-3.38-.27q-1.38-.28-2.23-1.12c-.85-.84-.91-1.3-1.12-2.23Q1 10.02 1 8q0-1.12.08-2.04.1-1.23.42-2.13a3.7 3.7 0 0 1 2.22-2.29C4.78 1.13 6.2 1 8 1m5.98 8.18a3 3 0 0 1-.88.85c-1.13.77-2.8.97-5.1.97s-3.97-.2-5.1-.97a3 3 0 0 1-.88-.85q.05 1.16.23 1.99c.18.8.46 1.34.85 1.73s.93.67 1.73.85c.81.18 1.84.25 3.17.25s2.36-.07 3.17-.25c.8-.18 1.34-.46 1.73-.85s.67-.93.85-1.73q.18-.82.23-2m-.14-3.82q-.59.73-1.56 1.1C11.22 6.88 9.8 7 8 7s-3.22-.13-4.28-.54a4 4 0 0 1-1.56-1.1q-.05.3-.08.64c.16 1.75.59 2.67 1.38 3.2.85.58 2.23.8 4.54.8s3.69-.22 4.54-.8c.8-.53 1.22-1.45 1.38-3.2q-.03-.34-.08-.65M8 2c-1.8 0-3.04.13-3.91.47A2.6 2.6 0 0 0 2.5 4c.32.76.8 1.23 1.58 1.53C4.96 5.87 6.2 6 8 6s3.04-.13 3.91-.47A2.6 2.6 0 0 0 13.5 4a2.6 2.6 0 0 0-1.58-1.53C11.04 2.13 9.8 2 8 2"/>`,
  },
  stylelint: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M4 3v3.5l1.5-1L7 15 .5 6l1-1.5L0 3l2.5-2h1zm12 0-1.5 1.5 1 1.5L9 15l1.5-9.5 1.5 1V3l.5-2h1zm-8 8.5a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1m0-3a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1m0-3a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1"/>
  <path fill="currentColor" d="M6.5 2.5V4l-2 1.5v-4zm5 3L9.5 4V2.5l2-1zM9 4H7V2.5h2z"/>`,
  },
  svelte: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="m3.98 3.7 3.36-2.08a4.5 4.5 0 0 1 5.9 1.23 4 4 0 0 1 .7 3.02q-.16.75-.58 1.4c.42.77.56 1.66.4 2.52a3.7 3.7 0 0 1-1.57 2.4l-.17.1-3.36 2.09a4.5 4.5 0 0 1-5.9-1.23 4 4 0 0 1-.66-1.44 4 4 0 0 1-.04-1.58 4 4 0 0 1 .58-1.4 4 4 0 0 1-.4-2.52 3.7 3.7 0 0 1 1.57-2.4zl3.36-2.08zm7.87 0a2.7 2.7 0 0 0-1.26-.95 2.7 2.7 0 0 0-1.6-.07 3 3 0 0 0-.52.2l-.16.09-3.36 2.08a2 2 0 0 0-.69.64 2 2 0 0 0-.36.86 2.3 2.3 0 0 0 .42 1.81A2.7 2.7 0 0 0 7.18 9.4q.28-.06.53-.2l.16-.09 1.28-.79.2-.09a.8.8 0 0 1 .87.31.7.7 0 0 1 .13.55.7.7 0 0 1-.24.4l-.08.05-3.36 2.08-.2.09a1 1 0 0 1-.49-.02 1 1 0 0 1-.38-.3 1 1 0 0 1-.13-.37v-.1l.01-.13-.13-.03a4 4 0 0 1-1.1-.5l-.2-.14-.18-.12-.07.18-.08.3a2.3 2.3 0 0 0 .43 1.82q.45.64 1.19.93.73.28 1.51.14l.16-.04q.27-.07.52-.2l.16-.09 3.36-2.08q.4-.25.69-.64.27-.4.36-.86a2.3 2.3 0 0 0-.42-1.82 2.7 2.7 0 0 0-1.27-.95 2.7 2.7 0 0 0-1.6-.08q-.27.07-.52.2l-.16.1-1.28.79-.2.09a1 1 0 0 1-.49-.03 1 1 0 0 1-.38-.29.7.7 0 0 1-.13-.54.7.7 0 0 1 .24-.4l.08-.06L9.33 4.4l.2-.1a.8.8 0 0 1 .87.32 1 1 0 0 1 .13.38v.22l.11.04q.6.18 1.12.5l.2.14.17.12.06-.19.08-.3a2.3 2.3 0 0 0-.42-1.81z"/>`,
  },
  'svg-2': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M5 7a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z"/>
  <path fill="currentColor" d="M6 1a5 5 0 0 1 4.58 3H7a3 3 0 0 0-3 3v3.58A5 5 0 0 1 6 1" opacity=".5"/>`,
  },
  svg: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8 1a1.28 1.28 0 0 1 .9 2.19V5.8l1.86-1.85a1.28 1.28 0 1 1 1.28 1.28L10.2 7.09h2.62a1.28 1.28 0 1 1 0 1.82H10.2l1.85 1.85a1.28 1.28 0 1 1-1.28 1.28L8.91 10.2v2.62a1.28 1.28 0 1 1-1.82 0V10.2l-1.85 1.85a1.28 1.28 0 1 1-1.28-1.28L5.8 8.91H3.2a1.28 1.28 0 1 1 0-1.82h2.6L3.96 5.24a1.28 1.28 0 1 1 1.28-1.28L7.09 5.8V3.2A1.28 1.28 0 0 1 8 1"/>`,
  },
  svgo: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M9.43 4.8A.6.6 0 1 1 9.19 6l-.56.96a1.2 1.2 0 0 1 .32 1.58l.7.53a.89.89 0 1 1-.17.22l-.7-.52a1.2 1.2 0 0 1-1.4.25l-.56.87a.75.75 0 1 1-.57-.2 1 1 0 0 1 .32.05l.56-.87a1.2 1.2 0 0 1-.4-1.24l-1.2-.47a.56.56 0 1 1 .1-.28v.02l1.2.47a1.2 1.2 0 0 1 1.56-.55l.56-.97a.6.6 0 0 1-.15-.64.6.6 0 0 1 .63-.4"/>
  ...
  tailwind: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M8 4Q5.2 4 4.5 6.67q1.05-1.34 2.45-1c.53.12.91.5 1.33.9C8.98 7.23 9.77 8 11.5 8q2.8 0 3.5-2.67-1.05 1.34-2.45 1c-.53-.12-.91-.5-1.33-.9C10.52 4.77 9.73 4 8 4M4.5 8Q1.7 8 1 10.67q1.05-1.34 2.45-1c.53.12.91.5 1.33.9C5.48 11.23 6.26 12 8 12q2.8 0 3.5-2.67-1.05 1.34-2.45 1c-.53-.12-.91-.5-1.33-.9C7.02 8.77 6.24 8 4.5 8" clip-rule="evenodd"/>`,
  },
  terraform: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M1 0v5.05l4.35 2.53V2.53zm9.18 5.34L5.83 2.82v5.05l4.35 2.53zm.47 5.06V5.34L15 2.82v5.05zm-.48 5.6-4.35-2.53V8.42l4.35 2.53z"/>`,
  },
  typescript: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" fill-rule="evenodd" d="M8 0c6.59 0 8 1.41 8 8s-1.41 8-8 8-8-1.41-8-8 1.41-8 8-8m2.32 5.01q-.44 0-.8.13t-.63.37a2 2 0 0 0-.4.56q-.15.32-.15.72t.14.7.41.53.6.4.7.32q.3.12.5.25.2.12.3.24a1 1 0 0 1 .14.27q.04.15.04.34 0 .22-.08.4a.6.6 0 0 1-.25.28 1 1 0 0 1-.44.1q-.24 0-.42-.05a1 1 0 0 1-.32-.2 1 1 0 0 1-.2-.34 2 2 0 0 1-.06-.5H8.23q0 .52.17.91t.47.64.68.39q.4.12.82.12.45 0 .82-.12.37-.13.63-.36.26-.24.4-.56.13-.33.13-.72a2 2 0 0 0-.11-.72 2 2 0 0 0-.34-.55 2 2 0 0 0-.55-.45 5 5 0 0 0-.78-.37l-.44-.19-.33-.21a1 1 0 0 1-.21-.24 1 1 0 0 1-.08-.3q0-.24.09-.42a.6.6 0 0 1 .26-.29 1 1 0 0 1 .45-.1q.29 0 .47.12a.7.7 0 0 1 .27.35q.09.23.09.52h1.17q0-.56-.24-1a2 2 0 0 0-.69-.7Q10.94 5 10.32 5m-6.79.1v.98h1.59v5.41h1.17v-5.4H7.9V5.1z" clip-rule="evenodd"/>`,
  },
  vite: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M8.57 14.87c-.18.26-.55.11-.55-.22v-3.18l-.05-.27-.13-.22-.2-.15-.24-.06H4.29c-.26 0-.4-.32-.26-.55L6.08 7c.3-.46 0-1.1-.5-1.1H1.8c-.25 0-.4-.32-.25-.56l2.65-4.2A.3.3 0 0 1 4.46 1h7.9c.26 0 .4.32.26.55l-2.05 3.23c-.29.46 0 1.1.5 1.1h3.12c.26 0 .4.34.24.57z"/>`,
  },
  vscode: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="m5.11 9.68-2.4 1.84a.6.6 0 0 1-.75-.04l-.77-.7a.6.6 0 0 1 0-.87L3.28 8zm5.52-8.42a.51.51 0 0 1 .87.36V4.8L7.32 8 5.1 6.32z" opacity=".75"/>
  ...
  vue: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M9.62 2.25 8 5.02 6.38 2.25H1l7 12 7-12z" opacity=".5"/>
  <path fill="currentColor" d="M9.54 2.25 8 4.95l-1.54-2.7H4l4 7 4-7z"/>`,
  },
  'wasm-duo': {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M13 1a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h3a2 2 0 1 0 4 0z" class="subtract" opacity=".2"/>
  ...
  wasm: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M13 1a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h3a2 2 0 1 0 4 0zM4.12 13h.99l.77-3.4h.02l.7 3.4h.97l1.25-5h-.96l-.76 3.45L6.37 8h-.91l-.8 3.4h-.02L3.98 8H3zm4.55 0h.97l.26-1.11h1.75l.33 1.11H13l-1.53-5H9.93zm2.74-1.93H10.1l.42-1.84h.41z"/>`,
  },
  webpack: {
    viewBox: '0 0 16 16',
    paths: `<path fill="currentColor" d="M14.1 11.79 8.26 15v-2.5l3.64-1.94zm.4-.35V4.73l-2.14 1.2v4.3zm-12.6.35L7.74 15v-2.5L4.1 10.56zm-.4-.35V4.73l2.14 1.2v4.3zm.25-7.15 6-3.29v2.42L3.9 5.47l-.03.01zm12.5 0L8.25 1v2.42l3.85 2.05.03.01z" class="bg" opacity=".4"/>
