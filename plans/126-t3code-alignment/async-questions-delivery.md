...
General files, durable staging/upload references, and native attachment-answer history remain under INTERACTION-02/04. Current per-question image drafts survive rejected responses but are not restored after reload.
