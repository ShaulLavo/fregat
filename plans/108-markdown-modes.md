...
| Piece               | Current state                                                                                                                                                                                                                                                                                                                        |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Plugin              | `createMarkdownPreviewPlugin` from `@singapore-editor/markdown`, installed in [`plugins.ts`](../apps/web/src/features/editor/utils/plugins.ts). Include it to turn preview on, remove it to turn it off — there is no user-facing mode.                                                                                              |
