...
Status: the shared handoff and the Problems list entry are implemented (Plan 140 P3, 2026-09-25); the hover and keyboard-popup entries are open. Cover every error and warning in diagnostic hover messages, the keyboard diagnostic popup, and the Problems list.
