...
Tested on 2026-09-07 with Bun 1.4.0, `@singapor/core` 0.1.2,
`@singapor/tree-sitter` 0.1.1, `@singapor/tree-sitter-languages` 0.1.1, and Shiki 4.2.0.

The viewer uses `createIncrementalTokenizer` from `@singapor/core/shiki` with a
...
LSP features use `@singapor/lsp` independently of syntax coloring.
