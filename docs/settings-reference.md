...
| `editor.inputRoute`                           | `"textarea"`      | application | How typed text reaches the editor. EditContext (Chromium) receives IME, autocorrect and dictation edits with their exact ranges; the textarea works everywhere and is what screen readers read. _(restart)_                                                      |
