...
| Setting                         | Default    | Scope   | What it does                                                                                                                                                                                                                                                                                                                               |
| ------------------------------- | ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `lsp.typescript.backend`        | `"server"` | machine | Run TypeScript language features on the server or in a browser worker.                                                                                                                                                                                                                                                                     |
| `lsp.typescript.workerMaxFiles` | `12000`    | machine | Maximum program files loaded by a TypeScript browser worker.                                                                                                                                                                                                                                                                               |
| `lsp.typescript.workerMaxBytes` | `67108864` | machine | Maximum source bytes loaded by a TypeScript browser worker. Runtime memory is higher.                                                                                                                                                                                                                                                      |
