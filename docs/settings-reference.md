...
| `workbench.palette`                | `"graphite"`   | window | Colors for app backgrounds, text, borders, and accents. Choose Graphite or Sage.         |
...
| `editor.retainedTextBudget`         | `67108864`        | machine | Text retained for parked projects when switching away from one, measured in UTF-16 code units across their open documents. The active project is never trimmed. |
