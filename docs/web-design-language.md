...
| Dividers            | Region boundaries use `border-border`; content dividers use `border-subtle`. Workbench region borders are intentionally transparent.      | `globals.css`, including the workbench-local subtle-divider derivation                                         |
